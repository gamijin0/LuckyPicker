...
if __name__=="__main__":
    one = TestBot(
        username="18862311156",
        password="xlsd1996",
        type="None",
        headers="{'Cookie': {'H5_INDEX_TITLE': 'boringstoler', '_T_WM': '3174d550c3d913475e78e9fb5646ebbb', 'SUB': '_2A251AxOZDeTxGedH6VQT8yzMzT-IHXVWD73RrDV6PUJbkdBeLVTxkW0Y46FID6eeksW65R0V9HPArJtVcw..', '_TTT_USER_CONFIG_H5': '%7B%22ShowMblogPic%22%3A1%2C%22ShowUserInfo%22%3A1%2C%22MBlogPageSize%22%3A10%2C%22ShowPortrait%22%3A1%2C%22CssType%22%3A0%2C%22Lang%22%3A1%7D', 'SUHB': '0cSm0W3IWr86_C', 'SCF': 'Ap2iLAJlczRzygt24OgHKivZWtgp_Hrepnrz1n3dsDocTjE9B_VSs4taCOw9oblXlm_8X1kDzE-pPeYDmMIycVQ.', 'H5_INDEX': '0_all', 'SSOLoginState': '1476879305', 'M_WEIBOCN_PARAMS': 'uicode%3D20000174'}, 'User-Agent': 'Mozilla/5.0(X11;Ubuntu;Linuxx86_64;rv', 'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8', 'Upgrade-Insecure-Requests': '1', 'Host': 'm.weibo.cn', 'Accept-Language': 'en-US,en;q=0.5', 'Cache-Control': 'max-age=0', 'Connection': 'keep-alive', 'Accept-Encoding': 'gzip,deflate'}"
    )
    # # one.login()
    # # one.saveHTML()
    #one.gotoIndex()
    ...
    #one.Care(1863157844)
    #print(one.Search(content=u"微博抽奖平台　红包"))
    # one.setProxys("http://ip.chinaz.com/getip.aspx")
    # proxies = {"http": "http://112.243.184.242:8888","http": "http://112.81.100.102:8888"}
    # res=requests.get("http://ip.chinaz.com/getip.aspx", proxies=proxies)
    # print(res.text)
